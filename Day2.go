...
const inputStr = `1208	412	743	57	1097	53	71	1029	719	133	258	69	1104	373	367	365
...
func main() {
	fmt.Println(Day2P1(inputStr))
	fmt.Println(Day2P2(inputStr))
}
